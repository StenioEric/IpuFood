...
### 🏠 Tela Principal
![Menu Screen](https://via.placeholder.com/300x600/4CAF50/FFFFFF?text=Menu+Screen)

### 🛒 Carrinho
![Cart Screen](https://via.placeholder.com/300x600/FF9800/FFFFFF?text=Cart+Screen)

### 📊 Relatórios
![Reports Screen](https://via.placeholder.com/300x600/2196F3/FFFFFF?text=Reports+Screen)

### 👤 Perfil
![Profile Screen](https://via.placeholder.com/300x600/9C27B0/FFFFFF?text=Profile+Screen)
